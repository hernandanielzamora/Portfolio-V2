      ...
      <section>
        ...
        <div className="aboutme-container">
          <p className="aboutme-text">
            Hey there! I'm Hernán Zamora, a passionate web developer with a
            knack for crafting innovative solutions. I'm on the verge of earning
            my software engineering degree from the Technological University of
            Argentina. During my academic journey, I've honed my skills in
            ...
            Redux, Ruby on Rails, and more. I'm always excited to embrace new
